...
extension ChatBox{
    class ViewModel: ObservableObject{
        ...
        //for gpt 4
        @Published var chat: [Chat] = [Chat(id: UUID(), role: .system, content: "You are a personal shopping assistant tasked to find dupes for fashion products. You know nothing else outside of fashion finds.", createAt: Date())]
